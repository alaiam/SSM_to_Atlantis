#################################
# Step 0.bis: create the correpondance between regular SSM and Atlantis for horizontal face
# It will be register in box_compostion_ww.csv & layer_max_ww.csv
# If this step is already done (you already have box_composition_ww), then go to step 2 (ww)
#################################
...
filename <- "regular_grid_variables_2011_W.nc"
...
write.csv(box_composition, "code_PS/box_composition_ww.csv",row.names=FALSE)
write.csv(layer_max, "code_PS/layer_max_ww.csv",row.names=FALSE)
