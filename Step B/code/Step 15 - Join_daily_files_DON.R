...
if (velma){
  nc_filename <- paste0(here(), "/pugetsound_SSM_Atlantis_LDON_velma_",year,".nc")
}else{
  nc_filename <- paste0(here(), "/pugetsound_SSM_Atlantis_LDON_","2011.nc")
}
...
# Create a NetCDF file
if (velma){
  nc_filename <- paste0(here(), "/pugetsound_SSM_Atlantis_RDON_velma_",year,".nc")
}else{
  nc_filename <- paste0(here(), "/pugetsound_SSM_Atlantis_RDON_","2011.nc")
}
...
plot(1:730, apply(atlantis_input_RDON, FUN = meanNA, MARGIN = 3))
plot(1:730, apply(atlantis_input_LDON, FUN = meanNA, MARGIN = 3))
