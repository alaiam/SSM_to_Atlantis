...
# Set path
if (velma){
  path <- paste0(here(), "/Step B/output_VELMA_",year,"_O2")
}else{
  path <- paste0(here(), "/Step B/output_No_VELMA_",year,"_O2")
}
setwd(path)
...
atlantis_input_O2[atlantis_input_O2==-1]<-NA
plot(1:730, apply(atlantis_input_O2, FUN = meanNA, MARGIN = 3))
