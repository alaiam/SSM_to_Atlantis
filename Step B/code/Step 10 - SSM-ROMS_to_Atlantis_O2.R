...
setwd("/home/atlantis/amps_hydrodynamics/")
year = 2095
...
Velma = T
if (Velma){
  filename <- paste0("VELMA/",year,"/regular_grid_O2_velma_",year,".nc")
  output_path <- paste0("/home/atlantis/amps_hydrodynamics/Step B/output_VELMA_",year,"_O2/")
  
}else{
  filename <- paste0("No_VELMA/regular_grid_O2_novelma_",year,".nc")
  output_path <- paste0("/home/atlantis/amps_hydrodynamics/Step B/output_No_VELMA_",year,"_O2/")
}
