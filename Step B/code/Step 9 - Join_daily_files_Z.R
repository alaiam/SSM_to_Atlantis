...
plot(1:730, apply(atlantis_input_LZ, FUN = meanNA, MARGIN = 3))
plot(1:730, apply(atlantis_input_SZ, FUN = meanNA, MARGIN = 3))
plot(1:730, apply(atlantis_input_MZ, FUN = meanNA, MARGIN = 3))
