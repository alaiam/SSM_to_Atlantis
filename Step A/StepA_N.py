...
for d in range(0, siglay_size):
  for t in range(0, time_size):  # Loop over time steps
        ...
        org_NH4 = ssm_solution.LZ[t][d].values  # Extract NH4 values
        org_NO3 = ssm_solution.SZ[t][d].values  # Extract NO3 values
...
plt.pcolormesh(mx, my, new_regular_NH4[350][1], cmap='viridis')
