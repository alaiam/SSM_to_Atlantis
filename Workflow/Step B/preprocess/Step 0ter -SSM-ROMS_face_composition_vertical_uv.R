...
# It call file from step 2 to have the w fluxes (ex: flux_ww_0015.csv for regular_grid_variables_ssm_00115.nc)
#################################
...
filename <- "regular_grid_variables_2011_U.nc"
...
write.csv(uxy2, "code_PS/uxy2_uv_code.csv",row.names=FALSE)
write.csv(full_face_composition, "code_PS/face_composition_uv.csv",row.names=FALSE)
